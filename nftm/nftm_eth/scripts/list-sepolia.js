...
const listNFT = async () => {
    ...
    let nftTxn = await myNftContract.listNFT("0xE7a85A68A066bb55CF03BD7ACFD7a13dfb579450", parseInt(process.argv[2], 10), 
                1000, {value: new BigNumber("1").toString()})
    ...
    await nftTxn.wait()
    console.log(`NFT Listed! Check it out at: https://sepolia.etherscan.io/tx/${nftTxn.hash}`);
